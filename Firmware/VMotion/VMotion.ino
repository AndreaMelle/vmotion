...
#define OUTPUT__MODE_ANGLES_BUTTON 5 //
...
int output_mode = OUTPUT__MODE_ANGLES_BUTTON;
...
void loop()
{
  ...
  if ((millis() - timestamp) >= OUTPUT__DATA_INTERVAL)
  {
    ...
    else if (output_mode == OUTPUT__MODE_ANGLES || output_mode == OUTPUT__MODE_ANGLES_BUTTON)  // Output angles
    {
      ...
      {
        if(output_mode == OUTPUT__MODE_ANGLES_BUTTON)
        {
          output_anglesbutton();
        }
        else
